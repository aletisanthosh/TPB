 ...
 * @function createInventoryForOrderPayment
 * @this LoInventory
 * @kind listobject
 * @namespace CORE
 * @param {LiOrderPayment} orderPayment
 * @param {Object} ivcInformation
 * @param {String} recordTypeId
 * @returns ivcMainPKey
 */
function createInventoryForOrderPayment(orderPayment, ivcInformation, recordTypeId){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
