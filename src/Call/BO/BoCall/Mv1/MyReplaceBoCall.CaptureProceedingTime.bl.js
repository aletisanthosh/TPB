 ...
 * @function replaceCaptureProceedingTime
 * @this BoCall
 * @kind businessobject
 * @namespace CUSTOM
 ...
 * @returns true
 */
function replaceCaptureProceedingTime(CallComplete){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (me.getLuCallMeta().getCaptureProceedingTime() == "1" || true) {
  ...
  if(Utils.isDefined(me.getStartTimeEffective()) && Utils.isDefined(me.getStopTimeEffective()) && me.getStartTimeEffective() === me.getStopTimeEffective() && me.getLuCallMeta().getCaptureProceedingTime() == "1") {
