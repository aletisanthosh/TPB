 ...
 * @function replaceGetButtonVisibility
 * @this BoCall
 * @kind businessobject
 * @namespace CUSTOM
 * @param {String} token
 * @returns visible
 */
function replaceGetButtonVisibility(token){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
switch (token) {
  case "btnComplete":
    visible = !bCallIsReadOnly && Utils.isDefined(me.getBpaMainPKey()) && !Utils.isEmptyString(me.getBpaMainPKey()) && me.getIsInProgress() === 1;
    break;
  ...
  case "btnTakeNewOrder":
    visible = !(me.getClbStatus() === "Completed" || me.getClbStatus() === "Abandoned" || me.getIsInProgress() == 0);
    break;
  case "btnStart":
    visible = !bCallIsReadOnly && Utils.isDefined(me.getBpaMainPKey()) && !Utils.isEmptyString(me.getBpaMainPKey()) && me.getIsInProgress() !== 1;
    break;
  case "btnTakeNewWholesaler":
    visible = !bCallIsReadOnly;
    break;
}
