 ...
 * @function replaceGetActivitiesForCard
 * @this LoActivitiesForStoreCockpit
 * @kind listobject
 * @namespace CUSTOM
 * @param {Object} visitIsInProgress
 * @param {String} CallStatus
 * @param {String} mobilityUserGuidance
 * @returns me
 */
function replaceGetActivitiesForCard(visitIsInProgress, CallStatus, mobilityUserGuidance){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
me.removeAllItems();
if(Utils.isDefined(visitIsInProgress) && visitIsInProgress === 1){
  var menuEntry1 = {
    "id" : "Survey",
...
if (CallStatus != "Completed" && CallStatus != "Canceled" && mobilityUserGuidance == "Sales" && Utils.isDefined(visitIsInProgress) && visitIsInProgress === 1){
  var menuEntry2 = {
    "id" : "CreateOrder",
