 ...
 * @function replaceGetCallsByDate
 ...
 * @returns promise
 */
function replaceGetCallsByDate(setDateFunction, filterCalls, currentDateStart, currentDateEnd, currentResponsiblePKey, numberOfListItems, cardMode, includeDailyReport){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var promise = dateDefer.then(
  function() {
    ...
    if (Utils.isDefined(includeDailyReport)) {
      jsonParams.push({
        "field" : "includeDailyReport",
        "operator" : "EQ",
        "value" : includeDailyReport
      });
    }
