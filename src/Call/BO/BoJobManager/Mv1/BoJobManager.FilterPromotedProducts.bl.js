 ...
 * @function filterPromotedProducts
 * @this BoJobManager
 * @kind businessobject
 * @namespace CORE
 * @param {DomPKey} posId
 ...
 * @returns posId
 */
function filterPromotedProducts(posId, boCall){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (loCurrentPOS.length > 0) {
  ...
  if(quickFilterApplied.length > 0) {
    ...
    loProducts.setFilterArray([{"category": category, "op": "EQ"}, {"planned": "1", "op": "EQ"}]);
  }
  else{
    loProducts.setFilter("planned", "1", "EQ");
  }
