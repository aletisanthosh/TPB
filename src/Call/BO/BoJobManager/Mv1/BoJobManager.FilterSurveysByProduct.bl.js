 ...
 * @function filterSurveysByProduct
 * @this BoJobManager
 ...
 * @param {Object} loProductQuickFilter
 */
function filterSurveysByProduct(prdMainPKey, posId, isPromotionFilterSet, isDiscrepanciesFilterSet, loProductQuickFilter){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (Utils.isDefined(this.getLoPOS().getCurrent()) && Utils.isDefined(this.getLoPOS().getCurrent().getSurveys())){
  var filterArray = [];
