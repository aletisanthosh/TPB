 ...
 * @returns promise
 */
function replaceAddProduct(productPKey, productId, posId){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (!Utils.isDefined(liProduct)) {
  ...
  promise = Facade.getObjectAsync("LuProduct", jsonQuery).then(
    function (lookup) {
      liProduct = {
        ...
        "prdGroupId" : lookup.groupSortOrder,
        "prdGroupItemId" : lookup.sortOrder,
        "eAN" : lookup.eAN,
        "prdId" : productId,
        "posId" : posId,
        "listedPlanned" : " ",
    ...
    function (jobDefinitionListLookup) {
      ...
      liProduct.setIsProductAddedManually("1", false);
      liProduct.setIsSurveyInitializedByManualPrdAdd("0", false);
  ...
  if(loProducts.getCurrent().getSvyDistributed() === "OutOfStock"){
    loProducts.getCurrent().setSvyDistributed("Distributed");
  }
}
