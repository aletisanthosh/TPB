 ...
 */
function replaceGetQuestions(posId, ignoreCallState){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (Utils.isDefined(liCurrentPOS) && liCurrentPOS.getQuestionsInitialized()!=="1" && (me.getClbStatus() == "Planned" || ignoreCallState)) {
    ...
    if ( (isStorePOS || matchingPOS) || (liCurrentPOS.getIsPOS() === "0" && Utils.isDefined(existingJobsOfThisCall) ) ) {
      if (createQuestion) {
        var questionitem = {
          ...
          "templateName" : questionJobDef.getTemplateName(),
          "decimalMinValue" : questionJobDef.getDecimalMinValue(),
          "decimalMaxValue" : questionJobDef.getDecimalMaxValue()
        };
  ...
  liCurrentPOS.setQuestionCount(liPOSCount, true);
  liCurrentPOS.setQuestionsInitialized("1", true);
  var loQuestions= me.getLoQuestions();
  loQuestions.addListItems(questionlist);
  me.setQuestionsInitialized("1", true);
}
