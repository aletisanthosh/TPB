...
var clbMetaType = dicJsonQuery.clbMetaType;
...
// Hide Execute and Complete options from context menu. The user should enter the visit to start or complete the visit.    
...
//  contextMenuItemList.push(menuEntry4);
  ...
  if (clbMetaType === 'DailyReport') {
    menuEntry1.actionEnabled = "0";
    menuEntry2.actionEnabled = "0";
    menuEntry3.actionEnabled = "0";
    menuEntry4.actionEnabled = "0";
    menuEntry5.actionEnabled = "0";
    menuEntry6.actionEnabled = "0";
  }
