 ...
 * @function loadManagementInformation
 * @this BoWizardRescheduleCall
 * @kind businessobject
 * @async
 * @namespace CORE
 * @param {DomPKey} bpaMainPKey
 * @param {Date} dateFrom
 * @param {DomBool} calledByWizard
 * @returns promise
 */
function loadManagementInformation(bpaMainPKey, dateFrom, calledByWizard){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
