 ...
 * @function replaceGetAllCustomerTasksForCard
 ...
 * @returns promise
 */
function replaceGetAllCustomerTasksForCard(numberOfListItems, currentCustomerPKey){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
// guanshu 230414 #1033 
var dateTimeToday = Utils.convertForDBParam(Utils.getMaxDateTimeAnsi(), 'DomDate');
  ...
  function(issue) {
    ...
    for(var i = 0; i < issue.length; i++){
      ...
      if(issue[i].dueDate == Utils.getMinDateTimeDB()){
        ...
        if(Utils.isSfBackend()) {
          issue[i].dueDateText = Localization.localize(Utils.convertFullDate2Ansi(Utils.createDateByMilliSec(Utils.unixepochToTicks(issue[i].dueDate))), "date");
        }
        else {
