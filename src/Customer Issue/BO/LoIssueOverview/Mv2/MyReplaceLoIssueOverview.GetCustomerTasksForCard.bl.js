 ...
 * @function replaceGetCustomerTasksForCard
 * @this LoIssueOverview
 * @kind listobject
 * @namespace CUSTOM
 * @param {Object} visitList
 * @param {DomInteger} numberOfListItems
 * @param {String} cardDate
 * @returns promise
 */
function replaceGetCustomerTasksForCard(visitList, numberOfListItems, cardDate){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var visitAccountIdList = [];
visitList.forEach(function(item){
  visitAccountIdList.push(item.bpaMainPKey);
});
var strAccouId = visitAccountIdList.map(function(v){return "'"+v+"'";}).join(",");
if (Utils.isSfBackend()){
  ...
  jsonQuery.cond = " AND issuePhase IN ('initial', 'Released') AND Account_Task__c.Due_Date__c <> #minDate# AND Account_Task__c.Account__c IN ( "+ strAccouId ;
