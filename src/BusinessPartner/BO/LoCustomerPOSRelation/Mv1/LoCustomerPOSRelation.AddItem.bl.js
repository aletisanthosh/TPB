 ...
 * @namespace CORE
 * @param {DomPKey} posPKey
 * @param {DomPKey} customerPKey
 * @param {DomPKey} bpaRelMetaPKey
 */
function addItem(posPKey, customerPKey, bpaRelMetaPKey){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
me.addListItems([{
  "pKey" : Utils.isSfBackend() ? posPKey : PKey.next(),
  "posPKey" : posPKey,
  "customerPKey" : customerPKey,
  "bpaRelMetaPKey" : bpaRelMetaPKey,
