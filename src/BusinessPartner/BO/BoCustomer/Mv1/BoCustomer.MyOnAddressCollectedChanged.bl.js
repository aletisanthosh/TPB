 ...
 * @function myOnAddressCollectedChanged
 * @this BoCustomer
 * @kind businessobject
 * @namespace CUSTOM
 * @param {Object} bufferedEvents
 */
function myOnAddressCollectedChanged(bufferedEvents){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
for (var j = 0; j < bufferedEvents.length; j++) {
  ...
  for (var i = 0; i < currentEvent.modified.length; i++) {
    //reacting on the different attributes
        ...
        case "countryState":
        //perf fix
        if (currentEvent.newValues != currentEvent.oldValues) {
