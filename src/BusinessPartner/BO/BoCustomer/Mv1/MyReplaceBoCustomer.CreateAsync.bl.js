 ...
 * @returns promise
 */
function replaceCreateAsync(jsonQuery){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
me.setOwnerId(user.pKey);
// allow editing of email
me.setEmailEditable('1');
//me.setWorkloadStatus('Pending');
me.setSalesDivision('US Field Sales');
me.setType('Retail');
...
var promise = Facade.loadLookupsAsync(jsonParams).then(
  ...
  function (object) {
    ...
    //### DsLuRecordType  ###
    //#######################
        var jsonParams = {recordType: "Retailer"};
        return Facade.selectSQL("DsLuRecordType", "Account", jsonParams);
    }
  ).then(
  function (object) {
    me.setRecordTypeId(object[0].pKey);
...
.then(function (object) {
  ...
  me.getLoCustomerAddress().addItemChangedEventListener(me.myOnAddressCollectedChanged,me,"loAddress");
  me.getLoCustomerAddress().addItemChangedBatchEventListener(me.myOnAddressCollectedChanged,me,"loAddress");
...
Account Harmonization: obsolete */
  ...
  function (object) {
    ...
    return BoFactory.createObjectAsync(BO_MYPRIMARYWHOLESALER,{});
  }).then(
  function(boPrimaryWholesaler){
    me.setBoPrimaryWholesaler(boPrimaryWholesaler);
    return BoFactory.createObjectAsync(BO_MYSECONDARYWHOLESALER,{});
  }).then(
  function(boSecondaryWholesaler){
    me.setBoSecondaryWholesaler(boSecondaryWholesaler);
    return me;
});
