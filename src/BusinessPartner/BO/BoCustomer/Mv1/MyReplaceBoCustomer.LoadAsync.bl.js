 ...
 * @returns promise
 */
function replaceLoadAsync(jsonQuery){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var promise = Facade.getObjectAsync(BO_CUSTOMER, jsonQuery).then(
  ...
  function(loCustomerSalesRevenue){
    ...
    return BoFactory.loadObjectByParamsAsync(BO_MYPRIMARYWHOLESALER, me.getQueryBy("customerPKey", me.getPKey()));
  }).then(
  function(boPrimaryWholesaler){
    me.setBoPrimaryWholesaler(boPrimaryWholesaler);
    return BoFactory.loadObjectByParamsAsync(BO_MYSECONDARYWHOLESALER, me.getQueryBy("customerPKey", me.getPKey()));
}).then(
