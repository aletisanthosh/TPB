 ...
 * @namespace CORE
 * @param {DomPKey} pKey
 * @param {DomBpaSalutation} salutation
 * @param {DomText} lastName
 * @param {DomText} firstName
 * @param {DomDial} phone1
 * @param {DomDial} phone2
 * @param {String} cpPKey
 * @param {String} mainFunctionText
 */
function addItem(pKey, salutation, lastName, firstName, phone1, phone2, cpPKey, mainFunctionText){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var existingContacts = me.getItemsByParam({bpaContactPartnerPKey: cpPKey});
