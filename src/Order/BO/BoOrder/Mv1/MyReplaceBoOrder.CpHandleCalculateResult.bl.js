 ...
 * @function replaceCpHandleCalculateResult
 * @this BoOrder
 * @kind businessobject
 * @async
 * @namespace CUSTOM
 ...
 * @returns promise
 */
function replaceCpHandleCalculateResult(triggeredByFreeItem, result){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (result.CSTAT === true) {
  ...
  if (result.splittingGroup !== " ") {
    ...
    (Utils.round(result.Items[i].Price,6,ROUNDING_TYPE.FINANCIAL));
