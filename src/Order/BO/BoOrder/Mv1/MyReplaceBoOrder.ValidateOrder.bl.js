 ...
 * @function replaceValidateOrder
 * @this BoOrder
 * @kind businessobject
 * @namespace CUSTOM
 * @param {messageCollector} messageCollector
 */
function replaceValidateOrder(messageCollector){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (me.getPhase() != "Canceled" && me.getObjectStatus() != 9) {
  ...
  if(me.getCommitDate() > me.getDeliveryDate()){
    newError = {
        "level" : "error",
        "objectClass" : "BoOrder",
        "messageParams" : {},
        "messageID" : "CasSdoDeliveryDateLaterThanOrderDate"
      };
      messageCollector.add(newError);
  }
}
