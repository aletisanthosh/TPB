 ...
 * @function replacePrepareCategoryQuickFilterList
 * @this BoOrder
 * @kind businessobject
 * @async
 * @namespace CUSTOM
 ...
 * @returns promise
 */
function replacePrepareCategoryQuickFilterList(filterValue, promotion, filterCode){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var addItemsToLoProductCategoryFilter = function (items){
  ...
  for (var i=0; i<items.length; i++){
    var category = items[i].getGroupText();
...
if((ifSelectedInList || ifSelectedInCache) && promotion === "0"){
  ...
  ApplicationContext.set('groupTextFilter', selectedFilter);
