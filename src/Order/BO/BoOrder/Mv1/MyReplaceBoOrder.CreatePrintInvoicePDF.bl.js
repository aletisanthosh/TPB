 ...
 * @function replaceCreatePrintInvoicePDF
 * @this BoOrder
 * @kind businessobject
 * @async
 * @namespace CUSTOM
 ...
 * @returns promise
 */
function replaceCreatePrintInvoicePDF(finalPath, blobPkey){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var promise = loadLoAttachmentsPromise.then(
  function () {
    var accountNumber = me.getLuOrderer().getAccountNumber();
    var invoiceNumber = me.getOrderId();
    var curDate = Utils.createDateNow();
    var formatDay = function(d) { return d < 10 ? '0' + d : d; };
    var dateText = [curDate.getUTCFullYear(), formatDay(curDate.getUTCMonth() + 1), curDate.getUTCDate()].join('-');
    var fileType = Utils.getFileExtensionFromMediaPath(finalPath);
    var filename = [accountNumber, invoiceNumber, dateText].join('-') + "." + fileType;
