 ...
 * @function replaceReleaseButtonActive
 * @this BoOrder
 * @kind businessobject
 * @namespace CUSTOM
 * @returns editable
...
var authorizingAgent = me.getAuthorizingAgent();

if(me.getIsOrderPaymentRelevant() == '1'){
  var isPaymentDone = ((me.getIsPaymentCollected()  == "1" || me.getPaidAmountReceipt() === 0) && ((!Utils.isEmptyString(authorizingAgent))));
