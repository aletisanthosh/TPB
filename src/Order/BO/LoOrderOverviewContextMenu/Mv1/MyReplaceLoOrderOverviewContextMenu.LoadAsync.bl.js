 ...
 * @returns result
 */
function replaceLoadAsync(jsonParams){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
for (index in jsonParams.params) {
  switch (jsonParams.params[index].field) {
    ...
    case "syncStatus":
      ...
      break;
    case "callInProgress":
      callInProgress = jsonParams.params[index].value;
      break;
  }
}

enableViewInvoice = phase === "Released" ? '1' : '0';
...
if ((mobilityRelevant === "0") || (sdoSubtype==="Delivery") || (callInProgress === 0) || (bCallIsReadOnly)){
  enableCopy = "0";
}
...
var menuEntry4 = {
  "id": "0000005",
  "actionImg": "PrintPreviewDarkGrey24",
  "actionId": "ShowInvoice",
  "processEvent": "View Invoice",
  "actionEnabled": enableViewInvoice
};
...
if (pageLocation === "Call::StoreCockpitTabProcess" || pageLocation === "Order::OverviewCallProcess") {
