 ...
 * @function replaceDetermineSatisfiedRewardGroups
 ...
 * @returns promise
 */
function replaceDetermineSatisfiedRewardGroups(promotionPKey, loSelectablePromotion){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if(Utils.isEmptyString(promotionPKey)){
  loRewardGroups = me.getLoRewardGroups().getItems();
}else{
  loRewardGroups = me.getLoRewardGroups().getItemsByParamArray([{"promotionPKey": promotionPKey,"op":"EQ"}]);
}
