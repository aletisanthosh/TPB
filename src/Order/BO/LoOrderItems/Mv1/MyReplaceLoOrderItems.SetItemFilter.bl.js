 ...
 * @returns filterCode
 */
function replaceSetItemFilter(filterCode, categoryId, promotionPKey){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
switch (filterCode) 
{
  ...
  // 230311 guanshu #562
  case "Suggested":
    filterArray.push({"showInSuggested" : "1", "op" : "EQ"});
    break; 
  // 230313 guanshu #824
  case "Distributed":
    filterArray.push({"distributed" : "1", "op" : "EQ"});
    break;
  case "TPB Promo":
    filterArray.push({"tpbPromoted" : "1", "op" : "EQ"});
    break;
  case "History":
...
var categoryFilter = ApplicationContext.get("groupTextFilter");
var quickFilter;
...
if(Utils.isDefined(categoryFilter)){
  quickFilter = {"groupText" : categoryFilter, "op" : "EQ"};
  filterArray.push(quickFilter);
}
