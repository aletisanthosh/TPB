 ...
 * @function replaceCreateDisplayInformationForUoMItem
 * @this LoOrderItems
 * @kind listobject
 * @namespace CUSTOM
 ...
 * @returns info
 */
function replaceCreateDisplayInformationForUoMItem(unitOfMeasureItem, orderMeta){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
{
  unitDescription = "Carton";
  info.logicUnitsforDisplay = "Carton";
}
else if((unitDescription == "ConsumerUnit") || (unitDescription == "Consumer Unit"))
{
  unitDescription = "Each";
  info.logicUnitsforDisplay = "Each";
}
else if(unitDescription == "Layer")
{
  unitDescription = "Case";
  info.logicUnitsforDisplay = "Case";
}
else {
