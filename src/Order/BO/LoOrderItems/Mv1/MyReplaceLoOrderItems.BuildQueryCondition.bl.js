 ...
 * @function replaceBuildQueryCondition
 * @this LoOrderItems
 * @kind listobject
 * @namespace CUSTOM
 ...
 * @returns sqlParams
 */
function replaceBuildQueryCondition(jsonParams, criterionFilterValue){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
// 230311 guanshu #562
var considerSuggested;
// 230313 guanshu #824
var considerDistributed;
var considerTpbPromo;
...
for (index in jsonParams.params) {
  ...
  switch (jsonParams.params[index].field) {
    ...
    case "callOutOfStockProducts":
      ...
      break;
    // 230311 guanshu #562
    case "considerSuggested":
      considerSuggested = jsonParams.params[index].value;
      break;
    // 230311 guanshu #824
    case "considerDistributed":
      considerDistributed = jsonParams.params[index].value;
      break;
    case "considerTpbPromo":
      considerTpbPromo = jsonParams.params[index].value;
      break;
  }
}
...
//Suggested Products guanshu #562
var cndSugg = "";
//Distribution Products guanshu #824
var cndDistri = "";
var cndTpbPromo = "";
...
if (Utils.isCasBackend()) {
  if ((sdoSubType == "Delivery") && (disposalListProposal == "None")) {
    ...
    if ((phase == BLConstants.Order.PHASE_RELEASED) || (phase == BLConstants.Order.PHASE_CANCELED) || (phase == BLConstants.Order.PHASE_READY) || (syncStatus === BLConstants.Order.NOT_SYNCABLE)) {
      ...
      if (considerSuggested == 1) {
        cndSugg = "Suggested = #presentDefault#";
      }
      // 230313 guanshu #824
      cndDistri = "";

      if (considerDistributed == 1) {
        cndDistri = "Distributed = #presentDefault#";
      }
      cndTpbPromo ="";
      
      if (consideTpbPromo == 1) {
        cndTpbPromo = "TpbPromoted = #presentDefault#";
      }
      ...
      if ((Utils.isEmptyString(cndALClosedListing)) &&(filterByBpaAssortment == "0") && (filterBySdoAssortment == "0") && (filterByCurrentInventory == "0")) {
        ...
        // 230311 guanshu #562
        if (!Utils.isEmptyString(cndSugg)) {
          queryCondition += " OR (" + cndSugg + ")";
        }
        // 230313 guanshu #824
        if (!Utils.isEmptyString(cndDistri)) {
          queryCondition += " OR (" + cndDistri + ")";
        }
        if (!Utils.isEmptyString(cndTpbPromo)) {
          queryCondition += " OR (" + cndTpbPromo + ")";
        }
      }
      else {
        //Build query condition
  ...
  if ((sdoSubType == "Delivery") && (disposalListProposal == "None")) {
    ...
    if ((phase == BLConstants.Order.PHASE_RELEASED ) || (phase == BLConstants.Order.PHASE_CANCELED) || (phase == BLConstants.Order.PHASE_READY) || (syncStatus == BLConstants.Order.NOT_SYNCABLE)) {
      ...
      if (considerSuggested == 1) {
        cndSugg = "proposedProduct.Suggested = #presentDefault#";
      }
      // 230313 guanshu #824
      cndDistri = "";

      if (considerDistributed == 1) {
        cndDistri = "proposedProduct.Distributed = #presentDefault#";
      }
      cndTpbPromo = "";

      if (considerTpbPromo == 1) {
        cndTpbPromo = "proposedProduct.TpbPromoted = #presentDefault#";
      }
...
// 230311 guanshu #562
sqlParams.push({
  "field" : "considerSuggested",
  "value" : considerSuggested
});
// 230313 guanshu #824
sqlParams.push({
  "field" : "considerDistributed",
  "value" : considerDistributed
});
sqlParams.push({
  "field" : "considerTpbPromo",
  "value" : considerTpbPromo
});
