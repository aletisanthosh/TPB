 ...
 * @function validateTotalQuantityOfFreeItems
 * @this BoRewardProductValidation
 * @kind businessobject
 * @namespace CORE
 * @param {Object} messageCollector
 * @returns messageCollector
 */
function validateTotalQuantityOfFreeItems(messageCollector){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var reward = me.getHurdleEvaluationHelper().getLoRewards().getCurrent();
var totalQuantity = 0;
...
if(maxItemsForReward > 0) {
  ...
  if(totalQuantity > maxItemsForReward) {
    messageCollector.add({
      ...
      "messageID" : "CasSdoFreeProductTotalMaxValueExceeded",      
    });
  }
}
