 ...
 * @async
 * @namespace CORE
 * @param {String} tacticMetaPKey
 * @param {String} tacticMetaId
 * @returns promise
 */
function addTactic(tacticMetaPKey, tacticMetaId){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
var promise = BoFactory.loadObjectByParamsAsync("LuPrmMeta", me.getQueryBy('pKey', tacticMetaPKey)).then(
  function(luPrmMeta) {
    var pKey = PKey.next();
    var liTactic ={
      "pKey": pKey,
